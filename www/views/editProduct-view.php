<?php
// this class contains the method to display the page to allow admin to edit based on productID given in the url
include 'views/addProduct-view.php'; 
class editProductView extends addProductView{
	...
	protected function displayContent(){
		...
		if (!$this-> model-> adminLoggedIn) {
			...
			$html .= '<p>Sorry you are not allow to access this page.</p>'."\n";
		 	
	 }# end if 

	 // check if the product form has been submitted
	 if ($_POST['Update']) {
	 	$result = $this-> model-> processUpdateProduct();
	 	$product = $_POST;
